...
export function EventTimeline() {
  ...
  return (
    <section className="relative py-15 md:py-20 px-6 bg-gradient-to-b from-gray-950 via-gray-900 to-black text-white overflow-hidden">
      {/* Background glow */}
      ...
      <FadeInOnScroll>
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          {loading ? (
            <motion.div
              variants={fadeInUp}
              className="text-center text-gray-400 font-body px-6 py-10 bg-black/40 border border-white/10 rounded-xl"
            >
                  ...
                  <div className="bg-black/50 backdrop-blur-md border border-white/10 rounded-xl p-5 hover:bg-black/70 transition">
                    ...
                    {e.ticket_url ? (
                      <a
                        href={e.ticket_url}
                        target="_blank"
                        className="mt-3 inline-block bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 text-white px-5 py-2 rounded-xl font-semibold hover:scale-105 transition-transform duration-300 shadow-lg"
                      >
                        Buy Tickets
                      </a>
                    ) : null}
